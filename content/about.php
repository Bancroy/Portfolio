        ...
        <div class="row">
            ...
            <div class="column xs-14 offset-xs-1 offset-sm-1 offset-md-1 lg-10 offset-lg-1 offset-xl-1 row font-lato entries">
                ...
                <article class="column xs-16 md-8">
                    ...
                    <p>My highest priority is <strong>quality</strong>. Keeping code standarized, clean, short and functional is one of habits I stubbronly struggle to maintain.</p>
                </article>
                <article class="column xs-16 md-8">
                    <header>
