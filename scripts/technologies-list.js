...
$(document).ready(function technologiesList() {
    ...
    $("#skills .list li").on("click touch", function showResult(event) {
    ...
    var unblock = 0;
    $("#skills .list-block .dim").on("mousedown touchstart", function startUnblocking(event) {
        event.stopPropagation();
        event.preventDefault();
    ...
    }).on("mouseup mouseleave touchend touchcancel", function stopUnblocking(event) {
        event.stopPropagation();
        event.preventDefault();
